...
* Bump `spotbugs-maven-plugin` from 4.8.6.4 to 4.9.8.2
* Bump `maven-surefire-[report-]plugin` from 3.5.2 to 3.5.4
...
* Bump `maven-jar-plugin` from 3.4.2 to 3.5.0
* Bump `maven-install-plugin` from 3.1.3 to 3.1.4
* Bump `maven-gpg-plugin` from 3.2.7 to 3.2.8
* Bump `maven-enforcer-plugin` from 3.5.0 to 3.6.2
* Bump `maven-deploy-plugin` from 3.1.3 to 3.1.4
* Bump `maven-dependency-plugin` from 3.8.0 to 3.9.0
* Bump `maven-compiler-plugin` from 3.13.0 to 3.14.1
* Bump `maven-clean-plugin` from 3.4.0 to 3.5.0
* Bump `checkstyle` from 10.18.2 to 12.2.0
